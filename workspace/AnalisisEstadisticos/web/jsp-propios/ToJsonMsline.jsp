...
%>
	<div id="chart"></div>
	<input type="button" value="Actualizar Pagina" onclick="window.location='/AnalisisEstadisticosDS/m/analisisEstadistico'">
	<%=mslineChat.render()%>
<%
}
catch(Exception e){
	%>
		...
		<table id="ox_AnalisisEstadisticosDS_SignIn__errors_table1">
	<%
