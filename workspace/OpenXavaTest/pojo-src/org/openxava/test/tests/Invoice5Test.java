...
public class Invoice5Test extends ModuleTestBase {
	...
	public void testImportFromExcel() throws Exception {  
		...
		assertImportFromExcel("invoices5.xlsx", "2017", "1", "9/25/17", "No", "1,258.26");
		assertImportFromExcel("invoices5.xls", "2017", "1", "9/25/17", "No", "1,258.26");
		setLocale("es");
		assertImportFromExcel("invoices5.xlsx", "2017", "1", "25/09/2017", "No", "1.258,26");
	}
